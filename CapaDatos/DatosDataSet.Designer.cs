...
namespace CapaDatos.DatosDataSetTableAdapters {
    ...
    public partial class UsuariosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Usuarios` (`Usuario`, `Contraseña`) VALUES (?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Usuarios` SET `Usuario` = ?, `Contraseña` = ? WHERE ((`Id` = ?) AND ((? =" +
                " 1 AND `Usuario` IS NULL) OR (`Usuario` = ?)) AND ((? = 1 AND `Contraseña` IS NU" +
                "LL) OR (`Contraseña` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CapaDatos.Properties.Settings.Default.DatosConnectionString;
        }
        ...
        public virtual int Fill(DatosDataSet.UsuariosDataTable dataTable) {
        ...
        public virtual DatosDataSet.UsuariosDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DatosDataSet.UsuariosDataTable dataTable = new DatosDataSet.UsuariosDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DatosDataSet.UsuariosDataTable dataTable) {
